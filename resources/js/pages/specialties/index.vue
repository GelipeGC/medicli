            ...
            <div class="card-header border-0">
                <div class="row align-items-center">
                    ...
                    <div class="col text-right">
                        <router-link :to="{ name: 'specialties.create' }" class="btn btn-sm btn-success">
                ...
                <div class="table-responsive">
                    ...
                    >
                        <div slot="actions" slot-scope="props">
                            <router-link :to="{ name: 'specialties.edit', params: { id: props.rowData.id}}" 
                                        class="action-icon">
                                <span v-tooltip.top="{
...
import FieldsSpecialties from './FieldsSpecialties.js'
...
export default {
    ...
    methods: {
        ...
        async deleteSpecialty(specialty) {
            const { data } = await axios.delete(`/api/specialties/${specialty.id}/delete`)
            this.hasNotofy = true;
